...
/**
 * Pago del pedido (docs/design/10-pagos.md): producto + servicio, se paga
 * tras el claim y ANTES de confirmar la compra del producto. El buyer ve el
 * monto total, nunca el desglose viajero/Bringo/producto.
 */
    ...
    return (
      <Card className="rounded-[24px] border-semantic-up/30 bg-semantic-up/5 shadow-none">
        <CardContent className="flex items-center gap-3 px-8 py-5">
          ...
          <div>
            <p className="title-sm text-ink">Pedido pagado</p>
    ...
    <Card className="rounded-[24px] border-hairline shadow-none">
      <CardContent className="flex flex-wrap items-center justify-between gap-4 px-8 py-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="title-sm text-ink">Paga tu pedido</p>
            <p className="caption text-body-text">
              Requerido antes de confirmar tu compra. Cubre el producto, el
              viaje y la entrega de Bringo.
            </p>
          </div>
        </div>
        <Button
        ...
        >
          {checkout.isPending ? "Abriendo…" : "Pagar pedido"}
        </Button>
      </CardContent>
    </Card>
  );
